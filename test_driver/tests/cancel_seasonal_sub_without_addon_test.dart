...
//  final unit = 'sqft';  TODO: Rich text, not able to find
  ...
  setUpAll(() async {
    ...
    shipmentList[0][0] =
        'A bag of ${subscriptionCardProductDetails[0][0]} (5m)';
    shipmentList[0][1] = '\u00D7\u200A' '1';
    shipmentList[0][2] = '\u00D7\u200A' '0';

    shipmentList[1][0] =
        'A bag of ${subscriptionCardProductDetails[1][0]} (5m)';
    shipmentList[1][1] = '\u00D7\u200A' '1';
    shipmentList[1][2] = '\u00D7\u200A' '0';

    shipmentList[2][0] =
        'A bag of ${subscriptionCardProductDetails[2][0]} (5m)';
    shipmentList[2][1] = '\u00D7\u200A' '1';
    shipmentList[2][2] = '\u00D7\u200A' '0';

    shipmentList[3][0] =
        'A bag of ${subscriptionCardProductDetails[3][0]} (5m)';
    shipmentList[3][1] = '\u00D7\u200A' '1';
    shipmentList[3][2] = '\u00D7\u200A' '0';
  ...
  group('description', () {
    test(
      'C90272: Create and Cancel Seasonal In-Window Subscription',
      () async {
        ...
        // Confirm Cancelation
        await confirmCancelationScreen
            .verifyConfirmCancellationScreenIsDisplayed(
                false, '', subscriptionCardProductDetails);
        await sleep(Duration(seconds: 3));
        await confirmCancelationScreen.clickOnContinueButton();

        //        TODO: Not able to find these texts
//        await confirmCancelationScreen.verifyProcessingCancellationScreen();
//        await confirmCancelationScreen.verifyCancelationDoneScreen();
