...
void main() {
  ...
  group('Product Listing Screen Tests', () {
    test(
        'C73706: Navigation from product listing page (PLP) to product detail page (PDP) Lawn Goals',
        () async {
      //Quiz
      ...
      for (var menu in mainProductListingScreen.lawn_goals_menu) {
        ...
        await productListingScreen.verifyProductDetails(
            totalProductDisplayed, menu, 'Lawn Goals');
        //Go back to LawnGoals-Main Product Listing screen
        await productListingScreen.goToBack();
      }
      //Verify LawnGoals Elements
