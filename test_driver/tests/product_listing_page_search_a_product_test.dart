...
void main() {
  ...
  final searchTestData = 'Summer weed';

  //Product List to be displayed after Search
  final productList = [
    ...
    'Ortho® Weed B Gon® Weed Killer For Lawns Ready-To-Spray2',
    'Scotts® Turf Builder® Weed & Feed',
    'Ortho® Weed B Gon® Weed Killer for St.Augustinegrass Ready-to-Spray'
  ];
  ...
  group('Product Listing Screen Tests', () {
    test('C73054: Search a product', () async {
      //Quiz
      ...
      //Enter Product name
      await productSearchScreen.enterProductName(searchTestData);
      //Verify Search Result Screen
      for (var product in productList) {
        await productSearchScreen.verifySearchResult(product);
      }
      //Click on Search cancel button
      await productSearchScreen.clickOnSearchCancelButton();
      //Verify Main Product Listing Page content
      await mainProductListingScreen.verifyMainProductListingScreen();
