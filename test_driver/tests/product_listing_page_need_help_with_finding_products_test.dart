...
void main() {
  ...
  var email;
  final dyValuetoScrollScreen=100.00;
  ...
  group('Product Listing Screen Tests', () {
    test('C73057: Need help with finding the products', () async {
      //Quiz
      ...
      for (var menu in mainProductListingScreen.lawn_goals_menu) {
        // Click on Lawn Grow Menu
        await mainProductListingScreen.clickOnLawnGrowMenu(menu);
        final totalProductsDisplayed =
            await productListingScreen.getNumberOfProductsDisplayed();
        //Validate if totalProducts count is greater than 0
        await expect(totalProductsDisplayed > 0, true);
        //Verify Product Details Page
        await productListingScreen.verifyProductScreen(menu);
        await productListingScreen.goToBack();
      }
      ...
      await mainProductListingScreen.scrollElement(
          ...
          dy: dyValuetoScrollScreen);
      //Scroll back to Product Category section
