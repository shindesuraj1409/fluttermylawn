...
void main() async {
  ...
  final futureDateToVerify =
      DateFormat('EE MMM dd').format(DateTime.now().add(Duration(days: 2)));
  ...
  group(
    ...
    () {
      test('C100942: Edit a Water Task to Today', () async {
        ...
        await createTaskScreen.selectDateForWhenField(
            ...
            month: dateNow.month,
            year: dateNow.year,
            alreadySelectedDate: futureDate);
        //Verify Selected Day
        ...
        //The slider will close and the Reminder will be updated
