...
//  final unit = 'sqft';  TODO: Rich text, not able to find
  ...
  setUpAll(() async {
    ...
    shipmentList[1][0] = 'A bag of Scotts® Turf Builder® Lawn Food (5m)';
    shipmentList[1][1] = '\u00D7\u200A' '1';
    shipmentList[1][2] = '\u00D7\u200A' '0';
    ...
    shipmentList[4][0] = 'A bag of Scotts® Turf Builder® Lawn Food (5m)';
    shipmentList[4][1] = '\u00D7\u200A' '1';
    shipmentList[4][2] = '\u00D7\u200A' '0';
  ...
  group('description', () {
    test(
      'C90273: Create and Cancel Annual Subscription',
      () async {
        ...
        await confirmCancelationScreen
            .verifyConfirmCancellationScreenIsDisplayed(
                true, '106.86', subscriptionCardProductDetails);
