...
void main() async {
  ...
  group('deep links tests', () {
    group('logged in', () {
      ...
      test('/plp/category/grassSeeds', () async {
        await driver.requestData('raiseDeepLink|/plp/category/grassSeeds');
        await _productListingScreen.verifyProductScreen('Grass Seeds');
      });
    });
  });
}
