...
void main() async {
  ...
  setUpAll(() async {
    ...
    _notekScreen = AddNoteScreen(driver);
  });
  ...
  group('deep links tests', () {
    group('logged in', () {
      ...
      test('/Note', () async {
        await driver.requestData('raiseDeepLink|/Note');
        await _notekScreen.verifyNoteScreenCommonElementsAreDisplayed();
      });
    });
