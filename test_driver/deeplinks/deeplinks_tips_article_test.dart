...
void main() async {
  ...
  LawnTipsScreen _lawnTipsScreen;

  final articleId=deepLink_data['tips_ArticleId'];
  ...
  setUpAll(() async {
    ...
    _lawnTipsScreen= LawnTipsScreen(driver);
  });
  ...
  group('deep links tests', () {
    group('logged in', () {
      ...
      test('/tips/article/[articleid]', () async {
        await driver.requestData('raiseDeepLink|/tips/article/$articleId');
        await _lawnTipsScreen.verifyArticlePage(deepLink_data);
