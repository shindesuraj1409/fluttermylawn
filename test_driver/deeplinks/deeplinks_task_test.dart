...
void main() async {
  ...
  setUpAll(() async {
    ...
    _addTaskScreen = AddTaskScreen(driver);
  });
  ...
  group('deep links tests', () {
    group('logged in', () {
      ...
      test('/Task', () async {
        await driver.requestData('raiseDeepLink|/Task');
        await _addTaskScreen.verifyAddTaskScreenCommonElementsAreDisplayed();
      });
    });
