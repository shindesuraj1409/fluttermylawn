...
void main() async {
  ...
  group('deep links tests', () {
    group('logged in', () {
      ...
      test('/plp/category/weedControl', () async {
        await driver.requestData('raiseDeepLink|/plp/category/weedControl');
        await _productListingScreen.verifyProductScreen('Weed Control');
      });
    });
