...
void main() async {
  ...
  group('deep links tests', () {
    group('logged in', () {
      ...
      test('/ask/FeedSeedActivities', () async {
        await driver.requestData('raiseDeepLink|/ask/FeedSeedActivities');
        await _askScreen.verifyFeedAndSeedActivitiesIsDispplayed();
      });
    });
