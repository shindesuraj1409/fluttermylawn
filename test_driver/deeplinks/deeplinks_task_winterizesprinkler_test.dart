...
void main() async {
  ...
  group('deep links tests', () {
    group('logged in', () {
      ...
      test('/Task/winterizeSprinkler', () async {
        await driver.requestData('raiseDeepLink|/Task/winterizeSprinkler');
        await _createTaskScreen.verifyTaskScreenCommonElementsAreDisplayed(
