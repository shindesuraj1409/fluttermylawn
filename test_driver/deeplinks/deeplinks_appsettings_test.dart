...
void main() async {
  ...
  AppSettingScreen _appSettingScreen;
  ...
  setUpAll(() async {
    ...
    _appSettingScreen = AppSettingScreen(driver);
  });
  ...
  group('deep links tests', () {
    group('logged in', () {
      ...
      test('/appSettings', () async {
        await driver.requestData('raiseDeepLink|/appSettings');
        await _appSettingScreen.verifyAppSettingScreenIsDisplayed();
      });
    });
