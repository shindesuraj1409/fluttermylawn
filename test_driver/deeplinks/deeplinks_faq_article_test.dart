...
void main() async {
  ...
  var addonsList;
  final faqId = deepLink_data['faq_ArticleId'];
  final faqQuestion = deepLink_data['faq_question'];
  ...
  group('deep links tests', () {
    group('Annual Subscription without Addon', () {
      ...
      test('/faqs/[articleid]', () async {
        await driver.requestData('raiseDeepLink|/faqs/$faqId');
        await _faqScreen.verifyBillingFAQDescription(faqQuestion: faqQuestion);
      });
    });
