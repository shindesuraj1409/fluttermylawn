...
void main() async {
  ...
  ProductDetailsScreen _productDetailScreen;
  final productId = deepLink_data['pdp_DrupalProductId'];
  final productName = deepLink_data['product_name'];
  ...
  setUpAll(() async {
    ...
    _productDetailScreen = ProductDetailsScreen(driver);
  });
  ...
  group('deep links tests', () {
    group('logged in', () {
      ...
      test('/product/[drupalproductId]', () async {
        await driver.requestData('raiseDeepLink|/product/$productId');
        await _productDetailScreen
            .verifyProductDetailsCommonElements(productName);
      });
    });
