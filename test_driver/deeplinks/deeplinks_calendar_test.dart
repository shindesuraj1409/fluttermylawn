...
void main() async {
  ...
  CalenderScreen _calendarScreen;
  ...
  setUpAll(() async {
    ...
    _calendarScreen = CalenderScreen(driver);
  });
  ...
  group('deep links tests', () {
    group('logged in', () {
      ...
      test('/calendar', () async {
        await driver.requestData('raiseDeepLink|/calendar');
        await _calendarScreen.verifyCalenderScreenCommonElementsAreDisplayed();
      });
    });
