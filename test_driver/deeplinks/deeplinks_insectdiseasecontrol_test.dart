...
void main() async {
  ...
  ProductListingScreen _productListingScreen;
  ...
  setUpAll(() async {
    ...
    _productListingScreen = ProductListingScreen(driver);
  });
  ...
  group('deep links tests', () {
    group('logged in', () {
      ...
      test('/plp/category/InsectDiseaseControl', () async {
        await driver
            .requestData('raiseDeepLink|/plp/category/InsectDiseaseControl');
        await _productListingScreen
            .verifyProductScreen('Insect & Disease Control');
      });
    });
