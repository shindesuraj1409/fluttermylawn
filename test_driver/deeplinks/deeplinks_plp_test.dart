...
void main() async {
  ...
  MainProductListingScreen _productListingScreen;
  ...
  setUpAll(() async {
    ...
    _productListingScreen = MainProductListingScreen(driver);
  });
  ...
  group('deep links tests', () {
    group('logged in', () {
      ...
      test('/plp', () async {
        await driver.requestData('raiseDeepLink|/plp');
        await _productListingScreen.verifyMainProductListingScreen();
      });
    });
  },timeout: Timeout(
  Duration(minutes: 5)));
