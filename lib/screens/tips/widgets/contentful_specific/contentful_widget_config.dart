...
import 'package:my_lawn/screens/tips/widgets/contentful_specific/contentful_hyperlink.dart';
import 'package:my_lawn/screens/tips/widgets/contentful_specific/contentful_image.dart';
...
import 'package:my_lawn/screens/tips/widgets/contentful_specific/contentful_paragraph.dart';
import 'package:my_lawn/screens/tips/widgets/contentful_specific/contentful_unordered_list.dart';

import 'contentful_youtube_player.dart';

Options contentfulOptions(BuildContext context, assets) => Options(
      ...
      renderNode: RenderNode(
        {
          ...
          BLOCKS.EMBEDDED_ASSET.value: (node, next) => Images(
                node: node,
                assets: assets,
              ),
          ...
          INLINES.HYPERLINK.value: (node, next) {
            return Hyperlink(node, next, context);
          },
          'youtube': (node, next) => ContentfulYoutube(
